...
<template>
    <section>
        <div class="desc">
          ...
          <span v-if="selectedTZRadio === 'custom'">選択されたTimezoneの日時に基づき、時差を計算します</span>
          <div>
            <input type="radio" id="rd-default" v-on:change="onChange" name="tz-radio" value="default" checked/>
